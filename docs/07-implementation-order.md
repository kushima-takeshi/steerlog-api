...
ResourceSection Entity
SectionStudyStatus Entity
ResourceSectionRepository
SectionStudyStatusRepository
ResourceSectionService
SectionStudyStatusService
Section Controller
StudyStatus Controller
Service tests
```
...
studiedAtをnullに戻してもLevelHistoryは消えない
```
